...
struct BagtagConfig {
    #[serde(default)] install_code: String,
    #[serde(default)] install_date: String,
    #[serde(default)] machine_id: String,
    #[serde(default)] servers: Vec<String>,
}

fn bagtag_path() -> std::path::PathBuf { get_config().config_dir.join("bagtag.json") }
